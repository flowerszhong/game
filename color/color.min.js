...
! function() {
    var ADs = [];
        ADs[0] = ["大众消费手册", 
        "http://www.dzxfsc.com",
        "http://img.dzxfsc.com/wp-content/uploads/2015/08/book-cover.jpg"
        ];
        ...
        ADs[2] = ["Cherry 打字神器", 
        "http://www.dzxfsc.com/13531.html",
        "https://img.alicdn.com/imgextra/i2/1762621111/TB2F9sbjXXXXXbfXXXXXXXXXXXX_!!1762621111.jpg_430x430q90.jpg"
        ];

        ADs[3] = ["京东 - 德国进口奶粉", 
        "http://union.click.jd.com/jdc?e=&p=AyIHZRprFgIVDlIcWCVGTV8LRGtMR1dGXgVFTUdGW0pHRE5XDVULR0VTUlFTS1wDQUQNVwdeA0tdHEEFWA9tVx4EVRxSEgURNzEFOmB%2Fe3IXewlFAnkOBXs%2FR0tNQCUXVyUAGwRUHFgVABI3Vh1eEAUTBlITayVkbzcedVolABsEVBxYEQcbN1UeXx0EEwFXHV8QARs3Ug%3D%3D&t=W1dCFBBFC1pXUwkEBwpZRxgHRQcLREJEAQUcTVZUGAVJHk1cTQkTSxhBekcLVhtcHAUVBA%3D%3D",
        "http://img12.360buyimg.com/n1/s448x448_jfs/t2077/80/2136634768/110463/ac0615d9/56c2808aN90fdef9e.jpg"
        ];
        ADs[4] = ["京东 - 家用手持推杆吸尘器", 
        "http://union.click.jd.com/jdc?e=&p=AyIHZRprFQoWBF0ZWCVGTV8LRGtMR1dGXgVFTUdGW0pHRE5XDVULR0VTUlFTS1wDQUQNVwdeA0tdHEEFWA9tVx4HXR9YHQARNxIfBhFdRwcgeDBdYRtfN3lSTltRfTUXVyUAGwRUHFgVABI3Vh1eEAUTBlITayVkbzcDdVsUAxMGVBlSHAUiBVwYWhIBFgJcK1sQBhoBVB1TFQUQDlwrXA%3D%3D&t=W1dCFBBFC1pXUwkEBwpZRxgHRQcLREJEAQUcTVZUGAVJHk1cTQkTSxhBekcLVRNfFgoQBA%3D%3D",
        "http://img12.360buyimg.com/n1/jfs/t2332/229/606001288/33327/d0abb4d9/561c9f6dN746b263d.jpg"
        ];
    ...
    var e = $("#box"),
        ...
        f = {
            ...
            pause: function() {
                this._pause = !0, d.d_share.hide(), d.d_content.hide(), d.d_pause.show(), d.dialog.show();
                var AdObj = this.getADobj();
            ...
            getADobj:function(){
                var AdObj = '<a href="{url}" class="btn btn-restart">{title}</a><br><a href="{url}"><img id="adimg" src="{img}" /></a>';
                arrIndex = Math.floor(Math.random() * ADs.length);
                AdObj = AdObj.replace("{title}", ADs[arrIndex][0]);
                AdObj = AdObj.replace(/\{url\}/g, ADs[arrIndex][1]);
                AdObj = AdObj.replace("{img}", ADs[arrIndex][2]);
                return AdObj;
            },
            ...
            gameOver: function() {
                ...
                document.title = Game.lastLv > 0 ? "我闯过" + (Game.lastLv) + "关，我的视力超过" + Game.lastGameTxt + "！不服来战！" : "保护眼睛，16分以下不要再玩手机了！";
                this.overAD();
                if ($("#appendflag").val() > 0) {
                    var g = '';
                    var b = '';
        ...
        h = {
            ...
            getGameOverText: function(l) {
                var k = 15 > l ? 0 : Math.ceil((l - 15) / 5),
                    ...
                    n = o,
                    m = 2 * l * 0.95;
                return m = m > 90 ? 90 + 0.15 * l : m, m = Math.min(m, 100), {
                    txt: n,
                    percent: m.toFixed(2)
                }
            }
